...
def add_no_cache_headers(response):
    ...
    同时添加 CORS 头，允许 AgentUI 前端跨域访问（开发模式）。
    """
    # CORS 头 — 允许前端 dev server 跨域请求
...
# ── AgentUI 角色配置（9 个工位 Agent） ──
AGENT_ROLES = {
    "main": {"name": "小浩仔", "role": "主控", "color": "#e74c3c", "desk_index": 0},
    "android-dev": {"name": "安卓仔", "role": "Android开发", "color": "#2ecc71", "desk_index": 1},
    "ios-dev": {"name": "苹果仔", "role": "iOS开发", "color": "#ecf0f1", "desk_index": 2},
    "web-dev": {"name": "前端仔", "role": "Web开发", "color": "#e67e22", "desk_index": 3},
    "backend-dev": {"name": "后端仔", "role": "后端开发", "color": "#2c3e50", "desk_index": 4},
    "qa-lead": {"name": "测试仔", "role": "测试负责人", "color": "#f1c40f", "desk_index": 5},
    "devops": {"name": "运维仔", "role": "DevOps", "color": "#95a5a6", "desk_index": 6},
    "ui-designer": {"name": "设计仔", "role": "UI设计", "color": "#e91e8a", "desk_index": 7},
    "pm": {"name": "产品仔", "role": "产品经理", "color": "#3498db", "desk_index": 8},
}


@app.route("/agent-roles", methods=["GET"])
def agent_roles():
    """返回所有 Agent 角色配置，供 AgentUI 前端渲染工位名牌"""
    return jsonify(AGENT_ROLES)
